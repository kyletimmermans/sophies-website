// Determine if we need to switch to mobile or desktop
...
// Is mobile, needs mobile (doesnt have mobile in URL)
if (window.mobileCheck() && window.location.href.indexOf("mobile") == -1) {
